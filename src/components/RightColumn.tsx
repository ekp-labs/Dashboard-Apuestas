...
import { Sparkles, TrendingUp, Brain, Shield, ArrowRight, BarChart3, Activity } from 'lucide-react';
...
export const RightColumn: React.FC<RightColumnProps> = ({ onSelectOdds }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* CARD 1: SEÑAL DE VALOR DEL DÍA (VALUE BET +EV) */}
      <div className="bg-[#050C18] rounded-2xl p-4 sm:p-5 border border-[#142844] space-y-3 relative overflow-hidden">
        ...
        <div className="flex items-center justify-between pb-2 border-b border-[#1A2E4C]">
          ...
          <span className="text-[10px] font-mono font-bold text-[#00E5A0] bg-[#00E5A0]/10 border border-[#00E5A0]/30 px-2 py-0.5 rounded-full uppercase">
            MODELO v4.8
          </span>
        </div>
        ...
        <div className="bg-[#081220] border border-[#182A45] rounded-xl p-3.5 space-y-3">
          <div className="flex items-center justify-between gap-2">
            ...
            {/* VALUE +8.7% Badge */}
            <div className="bg-[#00E5A0]/15 border border-[#00E5A0]/50 text-[#00E5A0] font-heading font-black text-sm px-2.5 py-1 rounded-xl">
          ...
          <div className="space-y-1 pt-1">
            <div className="flex justify-between text-[11px] font-mono">
              ...
              <span className="text-slate-400">Mercado Cuotas: <strong className="text-slate-200">{valueBetOpportunity.marketProb}%</strong></span>
            </div>
            
            <div className="w-full bg-[#12223A] h-2 rounded-full overflow-hidden flex">
              <div
                className="bg-[#00E5A0] h-full transition-all duration-500"
          ...
          <p className="text-[11px] text-slate-300 italic bg-[#0A1628] p-2.5 rounded-xl border border-[#162742] leading-snug">
            💡 {valueBetOpportunity.recommendation}
          </p>

          <button
            onClick={() => onSelectOdds(valueBetOpportunity.match, valueBetOpportunity.title, 2.10)}
            className="w-full py-2 bg-[#00E5A0] text-[#060B14] font-heading font-black text-xs uppercase tracking-wider rounded-xl hover:bg-[#00c98c] transition-colors flex items-center justify-center gap-1.5"
          >
      ...
      <div className="bg-[#050C18] rounded-2xl p-4 sm:p-5 border border-[#142844] space-y-4">
        ...
        <div className="space-y-2.5 bg-[#081220] border border-[#182A45] p-3 rounded-xl">
          <div className="text-center pb-1 border-b border-[#142640]">
          ...
          <div className="space-y-2 text-xs">
            ...
            <div>
              <div className="flex justify-between text-[11px] font-mono text-slate-300 mb-1">
                ...
                <span className="text-slate-400">Eficiencia Ofensiva</span>
            ...
            <div>
              <div className="flex justify-between text-[11px] font-mono text-slate-300 mb-1">
                <span>{teamA} (88%)</span>
                <span className="text-slate-400">Solidez Defensiva</span>
                <span>{teamB} (82%)</span>
              </div>
              <div className="w-full bg-[#12223A] h-1.5 rounded-full overflow-hidden flex">
                <div className="bg-blue-500 h-full" style={{ width: '52%' }}></div>
                <div className="bg-purple-500 h-full" style={{ width: '48%' }}></div>
              </div>
            </div>
            ...
            <div>
              <div className="flex justify-between text-[11px] font-mono text-slate-300 mb-1">
                ...
                <span className="text-slate-400">Presión Alta</span>
      ...
      {/* CARD 3: RENDIMIENTO DEL MODELO Y METRICAS */}
      <div className="bg-[#050C18] rounded-2xl p-4 border border-[#142844] space-y-3">
        <div className="flex items-center justify-between pb-2 border-b border-[#1A2E4C]">
          <h2 className="font-heading font-black text-sm text-white uppercase tracking-wider flex items-center gap-1.5">
        ...
        <div className="grid grid-cols-2 gap-2 text-center font-mono">
          <div className="bg-[#081220] border border-[#182A45] p-2.5 rounded-xl">
            <div className="text-[10px] text-slate-400 uppercase">PRECISIÓN MES</div>
            <div className="text-lg font-bold text-[#00E5A0]">{liveStats.aiAccuracy}</div>
          </div>

          <div className="bg-[#081220] border border-[#182A45] p-2.5 rounded-xl">
            <div className="text-[10px] text-slate-400 uppercase">VALUE BETS HOY</div>
            <div className="text-lg font-bold text-white">{liveStats.valueBetsFoundToday}</div>
          </div>
        </div>
      </div>
